...
let myPlanDummy = [
    ...
    Plan(id: 1, title: "길순이 경주여행", dateRange: nil, isPinned: true, imageURL: nil, sortOrder: 1, places: [], summary: summaryText),
    Plan(id: 1, title: "닐순이 경주여행", dateRange: nil, isPinned: true, imageURL: nil, sortOrder: 2, places: [], summary: summaryText),
    Plan(id: 1, title: "딜순이 경주여행", dateRange: nil, isPinned: true, imageURL: nil, sortOrder: 3, places: [], summary: summaryText),
    Plan(id: 1, title: "릴순이 경주여행", dateRange: "2025년 11월 24일 - 11월 25일", isPinned: false, imageURL: nil, sortOrder: 4, places: [], summary: summaryText),
    Plan(id: 1, title: "밀순이 경주여행", dateRange: "2025년 11월 24일 - 11월 25일", isPinned: false, imageURL: nil, sortOrder: 5, places: [], summary: summaryText),
    Plan(id: 1, title: "빌순이 경주여행", dateRange: "2025년 11월 24일 - 11월 25일", isPinned: false, imageURL: nil, sortOrder: 6, places: [], summary: summaryText),
    Plan(id: 1, title: "실순이 경주여행", dateRange: "2025년 11월 24일 - 11월 25일", isPinned: false, imageURL: nil, sortOrder: 7, places: [], summary: summaryText),
    Plan(id: 1, title: "일순이 경주여행", dateRange: "2025년 11월 24일 - 11월 25일", isPinned: false, imageURL: nil, sortOrder: 8, places: [], summary: summaryText),
]
